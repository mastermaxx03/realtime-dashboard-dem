    ...
    <div style={modalCardStyle} onClick={handleCardClick}>
      ...
      <div style={modalHeaderStyle}>
        <h2 style={modalHeaderTitleStyle}>
          {data.title || "3 PHASE VOLTAGE L-L"}{" "}
          ...
          <table style={professionalTableStyle}>
            <thead>
              <tr>
                ...
                <th
                  style={{ ...professionalTableThStyle, textAlign: "center" }}
                >
                  Tag
                </th>
                <th
            ...
            <tbody>
              {data.phasorTable.map((row, index) => {
                ...
                const tdStyle = isLastRow
                  ? { ...professionalTableTdStyle, borderBottom: "none" }
                  : professionalTableTdStyle;
      ...
      {isTimeWindowOpen && (
        <RealtimeTimeWindow
          initialSettings={timeWindowSettings}
          onUpdate={onUpdateTimeWindow}
          onCancel={onCloseTimeWindow}
        />
      )}
    </div>
  );
